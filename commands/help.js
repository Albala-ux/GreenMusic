...
.setColor(COLOR)
.setDescription(`These are the command ${client.user.username} Bot, [INVITE ME](https://discord.com/api/oauth2/authorize?client_id=710222282491953274&permissions=36777152&scope=bot) `)
